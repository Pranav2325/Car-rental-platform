...
const CarDetails = () => {
  ...
  return car ? <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-16">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          {/* description*/}
            ...
            <div>
             ...
             <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {["360 Camera","Bluetooth","GPS","Heated Seats"].map((item,index)=>(
      ...
      <form onSubmit={handleSubmit} className="shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500">
        ...
        <p className="flex flex-center justify-between text-2xl text-gray-800 font-semibold">{currency}{car.pricePerDay}<span className="text-base text-gray-400 font-normal">per day</span></p>
        <hr className="border-borderColor my-6"/>
        ...
        <button className="w-full bg-primary hover:bg-primary-dull text-white rounded-xl font-medium transition-all py-3 cursor-pointer"> Book Now </button>
